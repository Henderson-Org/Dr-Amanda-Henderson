...
Your GP can also discuss vaccines recommended in pregnancy. Some, such as whooping cough (pertussis) and RSV, are given at particular times later in pregnancy, while influenza and COVID-19 can be given at any stage. Your GP can advise what is recommended for you and when.

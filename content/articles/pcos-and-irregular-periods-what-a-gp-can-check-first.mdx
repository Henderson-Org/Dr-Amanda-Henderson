...
No. PCOS is a common cause of reduced fertility, because ovulation can be irregular, but many people with PCOS do conceive - sometimes with lifestyle changes, cycle tracking, medications or fertility support. Your GP can outline the initial approaches.
